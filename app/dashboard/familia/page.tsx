    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] font-sans smooth-transition text-xs">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 grid lg:grid-cols-4 gap-8">
        ...
        <aside className="lg:col-span-1 space-y-6">
          ...
          <div className="glass-panel p-6 rounded-xl space-y-4 text-center">
            ...
            <div>
              <span className="text-[9px] uppercase tracking-widest text-neutral-400 font-bold block">Memorial Administrado</span>
              <h4 className="font-serif font-bold text-neutral-800 dark:text-neutral-100 text-xs mt-1">Alejandro Valenzuela</h4>
              <span className="text-[10px] text-neutral-400 font-mono">1948 - 2026</span>
            </div>
          </div>
          ...
          <div className="glass-panel p-6 rounded-xl space-y-4">
            ...
            <div className="space-y-3">
              {familyMembers.map((member) => (
                <div key={member.id} className="flex justify-between items-center text-[10px] border-b border-neutral-100 dark:border-neutral-800/80 pb-2 last:border-0 last:pb-0">
                  <div>
          ...
          <div className="glass-panel p-6 rounded-xl space-y-4 text-center">
            ...
            <p className="text-[10px] text-neutral-400 leading-relaxed">Código QR oficial del memorial. Imprímelo o compártelo para dar acceso directo al perfil de Alejandro.</p>
            ...
            <a 
              href="/memorial/alejandro-valenzuela"
              target="_blank"
              className="text-[9px] font-bold text-[var(--tenant-primary)] hover:underline block"
            >
              ver memorial activo
            </a>
          </div>
          ...
          <div className="glass-panel p-6 rounded-xl space-y-4 text-center">
            ...
            <p className="text-[10px] text-neutral-400 leading-relaxed">Genera un archivo comprimido .ZIP con todas las fotos, audios de voz originales y condolencias escritas del memorial.</p>
            <button 
              onClick={handleDownloadBackup}
              className="w-full py-2 rounded-full border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800/50 text-[9px] uppercase tracking-widest font-bold transition-colors flex items-center justify-center gap-1"
            >
        ...
        <main className="lg:col-span-3 space-y-8">
          ...
          <section className="glass-panel p-8 rounded-2xl border border-neutral-200 dark:border-neutral-800 text-left">
            ...
            <form onSubmit={handleUploadMemory} className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div>
                  <label className="text-[10px] uppercase tracking-widest text-neutral-400 block mb-1">Título del recuerdo</label>
                  <input 
                    type="text" 
                ...
                <div>
                  <label className="text-[10px] uppercase tracking-widest text-neutral-400 block mb-1">Tipo de Recuerdo</label>
                  <select 
                    value={uploadType}
                    onChange={(e) => setUploadType(e.target.value as "photo" | "story" | "audio")}
                    className="w-full bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg px-3 py-2 outline-none text-xs text-neutral-800 dark:text-neutral-200"
                  >
                ...
                {(uploadType === "photo" || uploadType === "audio") && (
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold text-neutral-600 dark:text-neutral-300 mt-2 block">
              ...
              <div className="space-y-4 flex flex-col justify-between">
                <div>
                  <label className="text-[10px] uppercase tracking-widest text-neutral-400 block mb-1">Relato o descripción corta</label>
                  <textarea 
                    rows={6} 
                    placeholder="Escribe la historia o añade detalles adicionales..."
                    value={uploadText}
                    onChange={(e) => setUploadText(e.target.value)}
                    className="w-full bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl px-4 py-2 outline-none text-xs resize-none"
                  ></textarea>
                </div>
          ...
          <section className="glass-panel p-8 rounded-2xl border border-neutral-200 dark:border-neutral-800">
            ...
            <form onSubmit={handleSendInvite} className="grid md:grid-cols-4 gap-4 items-end">
              <div>
                <label className="text-[10px] uppercase tracking-widest text-neutral-400 block mb-1">Nombre Completo</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="text-[10px] uppercase tracking-widest text-neutral-400 block mb-1">Parentesco</label>
                <select 
              ...
              <div>
                <label className="text-[10px] uppercase tracking-widest text-neutral-400 block mb-1">Correo Electrónico</label>
                <input 
                  type="email" 
            ...
            {showInviteSuccess && (
              <span className="text-[10px] text-green-500 font-bold block mt-3">
            ...
            <div className="space-y-4">
              <div className="grid md:grid-cols-3 gap-4">
                <label className={`p-4 rounded-xl border cursor-pointer flex flex-col justify-between transition-all ${privacyLevel === "public" ? "border-[var(--tenant-primary)] bg-[var(--tenant-primary)]/5" : "border-neutral-200 dark:border-neutral-800"}`}>
                  ...
                  />
                  <div>
                    <span className="font-serif font-bold text-xs block mb-1">Público General</span>
                    <span className="text-[10px] text-neutral-400 font-light block leading-relaxed">Cualquier persona que escanee el código QR o acceda al subdominio puede ver el memorial.</span>
                  </div>
                </label>
                ...
                <label className={`p-4 rounded-xl border cursor-pointer flex flex-col justify-between transition-all ${privacyLevel === "private" ? "border-[var(--tenant-primary)] bg-[var(--tenant-primary)]/5" : "border-neutral-200 dark:border-neutral-800"}`}>
                  ...
                  />
                  <div>
                    <span className="font-serif font-bold text-xs block mb-1">Privado Familiar</span>
                    <span className="text-[10px] text-neutral-400 font-light block leading-relaxed">Sólo las personas explícitamente invitadas por correo pueden ver o interactuar con el memorial.</span>
                  </div>
                </label>
                ...
                <label className={`p-4 rounded-xl border cursor-pointer flex flex-col justify-between transition-all ${privacyLevel === "password" ? "border-[var(--tenant-primary)] bg-[var(--tenant-primary)]/5" : "border-neutral-200 dark:border-neutral-800"}`}>
                  ...
                  />
                  <div>
                    <span className="font-serif font-bold text-xs block mb-1">Acceso por Clave</span>
                    <span className="text-[10px] text-neutral-400 font-light block leading-relaxed">El visitante debe ingresar un código o contraseña general definida por la familia al escanear el QR.</span>
                  </div>
                </label>
              </div>
              ...
              {privacyLevel === "password" && (
                <div className="mt-4 max-w-sm">
                  <label className="text-[10px] uppercase tracking-widest text-neutral-400 block mb-1">Contraseña de acceso general</label>
                  <input 
                    type="password" 
          ...
          <section className="glass-panel p-8 rounded-2xl border border-neutral-200 dark:border-neutral-800 text-left">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                <span className="text-[9px] uppercase tracking-widest text-neutral-400 font-bold block mb-1">Conectar Familiar</span>
                <div>
                  <label className="text-[9px] uppercase tracking-widest text-neutral-400 block mb-1">Nombre Completo</label>
                  <input 
                    type="text" 
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label className="text-[9px] uppercase tracking-widest text-neutral-400 block mb-1">Parentesco</label>
                    <select
                      value={nodeRelation}
                  ...
                  <div>
                    <label className="text-[9px] uppercase tracking-widest text-neutral-400 block mb-1">Período de Vida</label>
                    <input 
                      type="text" 
                ...
                {nodeSuccess && (
                  <span className="text-[9px] text-green-500 font-semibold block mt-2">✔ Familiar agregado correctamente</span>
                )}
              </form>

              {/* Lista Nodos Vinculados */}
              <div className="md:col-span-2 space-y-3">
                <span className="text-[9px] uppercase tracking-widest text-neutral-400 font-bold block mb-1">Conexiones Familiares Registradas</span>
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-3">
                  {treeNodes.map(node => (
                    <div key={node.id} className="p-3 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white/50 dark:bg-neutral-900/50 flex justify-between items-center">
                      <div>
                        <span className="font-serif font-bold text-neutral-800 dark:text-neutral-100 block text-xs">{node.name}</span>
                        <span className="text-[9px] text-neutral-400 font-light block">{node.relation} • {node.life}</span>
                      </div>
                      <button 
          ...
          <section className="glass-panel p-8 rounded-2xl border border-neutral-200 dark:border-neutral-800 text-left">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <form 
                ...
                className="p-5 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white/30 dark:bg-neutral-900/30 space-y-4"
              >
                <span className="text-[9px] uppercase tracking-widest text-neutral-400 font-bold block mb-1">Registrar Nuevo Hito</span>
                <div className="grid grid-cols-3 gap-2">
                  <div className="col-span-1">
                    <label className="text-[9px] uppercase tracking-widest text-neutral-400 block mb-1">Año</label>
                    <input 
                      type="number" 
                      placeholder="1974"
                      value={eventYear}
                  ...
                  <div className="col-span-2">
                    <label className="text-[9px] uppercase tracking-widest text-neutral-400 block mb-1">Título del Hito</label>
                    <input 
                      type="text" 
                ...
                <div>
                  <label className="text-[9px] uppercase tracking-widest text-neutral-400 block mb-1">Descripción del acontecimiento</label>
                  <textarea 
                ...
                {eventSuccess && (
                  <span className="text-[9px] text-green-500 font-semibold block mt-2">✔ Hito agregado con éxito</span>
                )}
              </form>

              {/* Lista Eventos Registrados */}
              <div className="md:col-span-2 space-y-3">
                <span className="text-[9px] uppercase tracking-widest text-neutral-400 font-bold block mb-1">Línea de Tiempo Configurada</span>
                  ...
                  {timelineEvents.map(ev => (
                    <div key={ev.id} className="p-3 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white/50 dark:bg-neutral-900/50 flex justify-between items-start gap-4">
                      <div className="flex gap-3 items-start">
                        <span className="font-mono text-xs font-bold text-[var(--tenant-primary)] bg-[var(--tenant-primary)]/10 px-2 py-0.5 rounded">{ev.year}</span>
                        <div>
                          <span className="font-bold text-xs text-neutral-800 dark:text-neutral-100 block">{ev.title}</span>
                          <p className="text-[10px] text-neutral-400 font-light mt-0.5 leading-relaxed">{ev.desc}</p>
                        </div>
                      </div>
                      <button 
      ...
      {showBackupModal && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white dark:bg-neutral-950 rounded-2xl max-w-sm w-full p-8 border border-neutral-200 dark:border-neutral-800 shadow-2xl relative text-center">
            <h3 className="font-serif text-sm font-bold mb-2 text-neutral-800 dark:text-neutral-100">Generando Copia de Seguridad</h3>
            <p className="text-[10px] text-neutral-400 mb-6">Estamos recopilando todos los archivos de audio, fotos originales en alta definición, relatos y cartas familiares.</p>
            ...
            <div className="flex justify-between items-center text-[9px] text-neutral-400 font-mono mb-6">
            ...
            {backupProgress === 100 ? (
              <button 
                ...
                className="w-full py-2.5 rounded-full bg-tenant-btn-main text-white hover:opacity-90 text-[10px] uppercase tracking-widest font-semibold transition-colors"
              >
              ...
              <button 
                disabled
                className="w-full py-2.5 rounded-full bg-neutral-200 dark:bg-neutral-800 text-neutral-400 text-[10px] uppercase tracking-widest font-semibold cursor-not-allowed"
              >
                Generando archivo...
              </button>
            )}
